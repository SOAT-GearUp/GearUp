...
public sealed class Comunicacao
{
    private Comunicacao() { }
    private Comunicacao(Guid osId, Guid clienteId, DestinatarioNotificacao destinatario, string mensagem)
    {
        Id = Guid.NewGuid();
        OrdemServicoId = osId;
        ClienteId = clienteId;
    ...
    public static Comunicacao Criar(Guid osId, Guid clienteId, DestinatarioNotificacao destinatario, string mensagem)
