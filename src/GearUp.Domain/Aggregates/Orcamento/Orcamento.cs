...
public sealed class Orcamento : AggregateRoot
{
    ...
    public static Orcamento Criar(Guid osId, int versao, IEnumerable<NovoItemOrcamento> itens)
    {
    ...
    public void Decidir(bool aprovado)
    {
