...
public static class DependencyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<IConsultarStatusOrdemServicoUseCase, ConsultarStatusOrdemServicoUseCase>();
        ...
        services.AddScoped<IDecidirOrcamentoExternoUseCase, DecidirOrcamentoExternoUseCase>();
